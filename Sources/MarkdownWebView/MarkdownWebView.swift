  ...
  public struct MarkdownWebView: PlatformViewRepresentable {
    ...
    public class Coordinator: NSObject, WKNavigationDelegate, WKScriptMessageHandler {
      ...
      init(parent: MarkdownWebView) {
        ...
        platformView.setContentHuggingPriority(.required, for: .horizontal)
      ...
      public func webView(_: WKWebView, decidePolicyFor navigationAction: WKNavigationAction) async
      ...
      public func userContentController(
        ...
        case "sizeChangeHandler":
          guard let sizeDict = message.body as? [String: Double],
            let height = sizeDict["height"],
            let width = sizeDict["width"]
          else { return }
          let contentHeight = CGFloat(height)
          let contentWidth = CGFloat(width)
          if platformView.contentHeight != contentHeight
            || platformView.contentWidth != contentWidth
          {
